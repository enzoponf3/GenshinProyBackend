...
namespace GenshinFarm.Api.Migrations
{
    ...
    [Migration("20201214170517_dbset-name-change")]
    partial class dbsetnamechange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DaysOfWeekWeaponAscensionMaterial", b =>
                {
                    b.Property<string>("DaysAvailableId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("WeaponAscensionMaterialId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("DaysAvailableId", "WeaponAscensionMaterialId");

                    b.HasIndex("WeaponAscensionMaterialId");

                    b.ToTable("DaysOfWeekWeaponAscensionMaterial");
                });
            ...
            modelBuilder.Entity("GenshinFarm.Core.Entities.WeaponAscensionMaterial", b =>
                {
                    b.HasBaseType("GenshinFarm.Core.Entities.Material");

                    b.HasDiscriminator().HasValue("WeaponAscensionMaterial");
                });
            ...
            modelBuilder.Entity("DaysOfWeekWeaponAscensionMaterial", b =>
                {
                    ...
                    b.HasOne("GenshinFarm.Core.Entities.WeaponAscensionMaterial", null)
                        .WithMany()
                        .HasForeignKey("WeaponAscensionMaterialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
